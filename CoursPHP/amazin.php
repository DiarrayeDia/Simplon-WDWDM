...
<?php    
    ...
    if (isset($_GET['step']) && $_GET['step'] == '2') {
        ...
        <h2>Question 2</h2>
            ...
            <a href="?step=3" role="button" class="btn btn-danger">non</a> <!-- rapporte 1 point -->
            <a href="?step=3" role="button" class="btn btn-secondary">sans avis</a> <!-- rapporte 0 point -->'
        ;
    }
    ...
    if (isset($_GET['step']) && $_GET['step'] == '3') {
        ...
        <h2>Question 3</h2>
            ...
            <a href="?step=4" role="button" class="btn btn-danger">non</a> <!-- rapporte -1 point -->'
        ;
    }
 ...
 Afficher ici le numéro de téléphone qui s'affiche au fur et à mesure de la saisie */  
        ...
        echo '<p>Votre numéro : #numéro de téléphone saisi#</p>
            <a href="?restart=y" role="button" class="btn btn-success">Valider</a>'
        ;

    }

    // Etape finale : A afficher si "oui" a été répondu à la question 3 ou si l'étape 4 a été résolue //
    if (isset($_GET['restart']) && $_GET['restart'] == "y") {
        echo 
